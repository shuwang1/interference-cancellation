...
\end{tabular}
\end{center}
\center{Table 1. The comparsion of the proposed semiblind
...
\begin{figure} \center{
\includegraphics[width=3in]{BER_SNR2.eps}
\caption{The BER performance comparsion of the single-user matched
filter, decorrelating detector and the proposed detectors. }
}\label{BER_SNR}
\end{figure}

In Fig. \ref{BER_SNR}, we compare the BER performance of the
proposed semiblind detectors with the single-user matched filter
and decorrelating detector against $SNR$

\begin{figure} \center{
\includegraphics[width=3in]{BER_NFR3.eps}
\caption{The near-far resistance comparsion of the single-user
matched filter, decorrelating detector and the proposed detectors.
} }\label{BER_NFR}
\end{figure}

\begin{figure} \center{
\includegraphics[width=3in]{BER_M.eps}
...
\begin{figure} \center{
\includegraphics[width=3in]{BER_P.eps}
\caption{The BER of the single-user matched filter, decorrelating
detector and the proposed detectors with changing $P$. }
}\label{BER_P}
\end{figure}
