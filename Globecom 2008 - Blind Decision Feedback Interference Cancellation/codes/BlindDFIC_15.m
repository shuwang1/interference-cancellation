...
for n =  1:n_Len
    ...
    for m = 1:length(SNR)
        ...
        for t = M-G+1 : TotalTrails
            ...
            switch amplitudeFiltering
                case -3
                    G_LS(:, G+1:M) = [ G_LS(:, (G+2):M) A(1:G,1:G)*b(1:G, t-1) ];
                case -2
                ...
                case 2
                    G_LS(:, G+1:M) = [ G_LS(:, (G+2):M)  b_LS(:, t-1).*mean(a_LS(:,max(t-M+G, 0):t-1), 2) ];                    
                otherwise
            ...
            switch amplitudeFiltering
                case -3
                    G_BMMSE(:, G+1:M) = [ G_BMMSE(:, (G+2):M) A(1:G,1:G)*b(1:G, t-1) ];
                case -2
                ...
                case 2
                    G_BMMSE(:, G+1:M) = [ G_BMMSE(:, (G+2):M) b_BMMSE(:, t-1).*mean(a_BMMSE(:,max(t-M+G, 0):t-1), 2) ];                    
            ...
            f_BMMSE = (C_SNR*sigma+S_BMMSE'*S_BMMSE)\(S_BMMSE'*r(1:LP,t));
            ...
            switch amplitudeFiltering
                case -3
                    G_TLS(:, G+1:M) = [ G_TLS(:, (G+2):M) A(1:G,1:G)*b(1:G, t-1) ];
                case -2
                ...
                case 2
                    G_TLS(:, G+1:M) = [ G_TLS(:, (G+2):M)  b_TLS(:, t-1).*mean(a_TLS(:,max(t-M+G, 0):t-1), 2) ];                    
                otherwise
            ...
            switch amplitudeFiltering
                case -3
                    G_MLS(:, G+1:M) = [ G_MLS(:, (G+2):M) A(1:G,1:G)*b(1:G, t-1) ];
                case -2
...
switch simulationConfig
    case 1
        figure(10)
        semilogy(A2A1, BER_MF(1,:),'-+', A2A1, BER_DD(1,:),'-o', A2A1, BER_LS(1,:),'-^', A2A1, BER_TLS(1,:),'-v', A2A1, BER_MLS(1,:),'->',A2A1, BER_BMMSE(1,:),'-x','LineWidth',3,'MarkerSize',15);
        grid;
        ...
        legend('MF','DD','LS','TLS','MLS','BMMSE');
        
        
        figure(100)
        semilogy(A2A1, BER_MF(1,:),'-s', A2A1, BER_DD(1,:),'-o', A2A1, BER_LS(1,:),'-^',A2A1, BER_BMMSE(1,:),'-v','LineWidth',3,'MarkerSize',18);
        grid;
        title('Near-Far Resistance Performance of Different Detectors');
        xlabel('Near-Far Resistance A_2/A_1(dB)','FontSize',18,'FontWeight','bold');
        ylabel('Bit-Error-Rate (BER)','FontSize',18,'FontWeight','bold');
        legend('MF','DD','LS/ML','BMMSE');
        
    case 2
        figure(20)
        semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff') , SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'-o', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-p', SNR, BER_LS(:,3), SNR, BER_TLS(:,1),'-d', SNR, BER_TLS(:,2),'-p', SNR, BER_TLS(:,3), SNR, BER_MLS(:,1),'-d', SNR, BER_MLS(:,2),'-p', SNR, BER_MLS(:,3),'-h','LineWidth',2,'MarkerSize',5)
        ...
        legend('SU-BPSK','MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','MF with A_2/A_1=10','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','LS with A_2/A_1=10','TLS with A_2/A_1=0.1','TLS with A_2/A_1=1.0','TLS with A_2/A_1=10','MLS with A_2/A_1=0.1','MLS with A_2/A_1=1.0','MLS with A_2/A_1=10');
 
        figure(21)
        semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff') , SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'-o', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-p', SNR, BER_LS(:,3), 'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        title('BER of Different Multiuser Detection Algorithms');
        xlabel('SNR (dB)','FontSize',24,'FontWeight','bold');
        ylabel('BER','FontSize',24,'FontWeight','bold');
        legend('SU-BPSK', 'MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','MF with A_2/A_1=10','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','LS with A_2/A_1=10');


        figure(210)
        semilogy(SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-p', SNR, BER_LS(:,3),'-o' ,'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        title('BER of Different Multiuser Detection Algorithms');
        ...
        figure(220)
        semilogy(SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--', SNR, BER_TLS(:,1),'-d', SNR, BER_TLS(:,2),'-p', SNR, BER_TLS(:,3),'-o' ,'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        title('BER of Different Multiuser Detection Algorithms');
        ...
        figure(230)
        semilogy(SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--', SNR, BER_MLS(:,1),'-d', SNR, BER_MLS(:,2),'-p', SNR, BER_MLS(:,3),'-o' ,'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        title('BER of Different Multiuser Detection Algorithms');
        ...
        figure(22)
        semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff') , SNR, BER_MF(:,1),'-*', SNR, BER_MF(:,2),'-+',SNR, BER_DD(:,2),'--', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-p',  SNR, BER_TLS(:,1),'-<', SNR, BER_TLS(:,2),'->', SNR, BER_MLS(:,1),'-v', SNR, BER_MLS(:,2),'-o', 'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        xlabel('E_b/N_o (dB)','FontSize',24,'FontWeight','bold');
        ylabel('BER','FontSize',24,'FontWeight','bold');
        legend('SU-BPSK','MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','TLS with A_2/A_1=0.1','TLS with A_2/A_1=1.0','MLS with A_2/A_1=0.1','MLS with A_2/A_1=1.0');
 

        figure(23)
        semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff') , SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--',  SNR, BER_LS(:,2),'-p', SNR, BER_LS(:,3), '-s', SNR, BER_TLS(:,2),'->', SNR, BER_TLS(:,3),'-^',  SNR, BER_MLS(:,2),'-o', SNR, BER_MLS(:,3),'-h','LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        xlabel('E_b/N_o (dB)','FontSize',24,'FontWeight','bold');
        ylabel('BER','FontSize',24,'FontWeight','bold');
        legend('SU-BPSK','MF with A_2/A_1=0.1','MF with A_2/A_1=10','DD with A_2/A_1=1.0','LS with A_2/A_1=1.0','LS with A_2/A_1=10','TLS with A_2/A_1=1.0','TLS with A_2/A_1=10','MLS with A_2/A_1=1.0','MLS with A_2/A_1=10');

        figure(24)
        subplot(1,2,1);
        semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff') , SNR, BER_MF(:,1),'-x', SNR, BER_MF(:,2),'-+',SNR, BER_DD(:,2),'--', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-s',  SNR, BER_TLS(:,1),'-<', SNR, BER_TLS(:,2),'->', SNR, BER_MLS(:,1),'-v', SNR, BER_MLS(:,2),'-o', 'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        ...
        legend('SU-BPSK','MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','TLS with A_2/A_1=0.1','TLS with A_2/A_1=1.0','MLS with A_2/A_1=0.1','MLS with A_2/A_1=1.0');
        subplot(1,2,2)
        semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff') , SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--',  SNR, BER_LS(:,2),'-s', SNR, BER_LS(:,3), '-d', SNR, BER_TLS(:,2),'->', SNR, BER_TLS(:,3),'-<',  SNR, BER_MLS(:,2),'-o', SNR, BER_MLS(:,3),'-v','LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        ...
        figure(25)
        semilogy(SNR, BER_MF(:,1),'-x', SNR, BER_MF(:,2),'-+',SNR, BER_DD(:,2),'--', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-s',  SNR, BER_TLS(:,1),'-<', SNR, BER_TLS(:,2),'->', SNR, BER_MLS(:,1),'-v', SNR, BER_MLS(:,2),'-o', SNR, BER_BMMSE(:,1),'-^', SNR, BER_BMMSE(:,2),'-p', 'LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        xlabel('E_b/N_o (dB)','FontSize',24,'FontWeight','bold');
        ylabel('BER','FontSize',24,'FontWeight','bold');
        legend('MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','TLS with A_2/A_1=0.1','TLS with A_2/A_1=1.0','MLS with A_2/A_1=0.1','MLS with A_2/A_1=1.0','BMMSE with A_2/A_1=0.1','BMMSE with A_2/A_1=1.0');

        figure(26)
        semilogy(SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--',  SNR, BER_LS(:,2),'-s', SNR, BER_LS(:,3), '-d', SNR, BER_TLS(:,2),'->', SNR, BER_TLS(:,3),'-<',  SNR, BER_MLS(:,2),'-o', SNR, BER_MLS(:,3),'-v',  SNR, BER_BMMSE(:,2),'-p', SNR, BER_BMMSE(:,3), '-^','LineWidth',4,'MarkerSize',10)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        xlabel('E_b/N_o (dB)','FontSize',24,'FontWeight','bold');
        ylabel('BER','FontSize',24,'FontWeight','bold');
        legend('MF with A_2/A_1=1.0','MF with A_2/A_1=10','DD with A_2/A_1=1.0','LS with A_2/A_1=1.0','LS with A_2/A_1=10','TLS with A_2/A_1=1.0','TLS with A_2/A_1=10','MLS with A_2/A_1=1.0','MLS with A_2/A_1=10','BMMSE with A_2/A_1=1.0','BMMSE with A_2/A_1=10');

        
        
        figure(250)
        semilogy(SNR, BER_MF(:,1),'-x', SNR, BER_MF(:,2),'-+',SNR, BER_DD(:,2),'--', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-s',  SNR, BER_BMMSE(:,1),'-^', SNR, BER_BMMSE(:,2),'-p', 'LineWidth',4,'MarkerSize',18)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
        xlabel('E_b/N_o (dB)','FontSize',24,'FontWeight','bold');
        ylabel('BER','FontSize',24,'FontWeight','bold');
        legend('MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','BMMSE with A_2/A_1=0.1','BMMSE with A_2/A_1=1.0');

        figure(260)
        semilogy(SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'--',  SNR, BER_LS(:,2),'-s', SNR, BER_LS(:,3), '-d', SNR, BER_BMMSE(:,2),'-p', SNR, BER_BMMSE(:,3), '-^','LineWidth',4,'MarkerSize',18)
        ylim([1.0/TotalTrails 0.55])
        xlim([min(SNR) max(SNR)])
        grid;
        %title('BER of Different Multiuser Detection Algorithms');
...
figure(27)
semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff'), SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'-o', SNR, BER_LS(:,1),'-d', SNR, BER_LS(:,2),'-p', SNR, BER_LS(:,3),'-h','LineWidth',4,'MarkerSize',10)
ylim([1.0/TotalTrails 0.55])
xlim([min(SNR) max(SNR)])
grid;
title('BER of Different Multiuser Detection Algorithms');
xlabel('SNR (dB)','FontSize',14,'FontWeight','bold');
ylabel('Bit-Error-Rate BER','FontSize',14,'FontWeight','bold');
legend('BPSK','MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','MF with A_2/A_1=10','DD with A_2/A_1=1.0','LS with A_2/A_1=0.1','LS with A_2/A_1=1.0','LS with A_2/A_1=10');

figure(28)
semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff'), SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'-o', SNR, BER_TLS(:,1),'-d', SNR, BER_TLS(:,2),'-p', SNR, BER_TLS(:,3),'-h','LineWidth',4,'MarkerSize',10)
ylim([1.0/TotalTrails 0.55])
xlim([min(SNR) max(SNR)])
grid;
title('BER of Different Multiuser Detection Algorithms');
xlabel('SNR (dB)','FontSize',14,'FontWeight','bold');
ylabel('Bit-Error-Rate BER','FontSize',14,'FontWeight','bold');
legend('BPSK', 'MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','MF with A_2/A_1=10','DD with A_2/A_1=1.0','TLS with A_2/A_1=0.1','TLS with A_2/A_1=1.0','TLS with A_2/A_1=10');

figure(29)
semilogy(SNR, berawgn(EbNo, 'psk', 2,'nondiff'), SNR, BER_MF(:,1),'-*',SNR, BER_MF(:,2),'-+',SNR, BER_MF(:,3),'-x', SNR, BER_DD(:,2),'-o', SNR, BER_MLS(:,1),'-d', SNR, BER_MLS(:,2),'-p', SNR, BER_MLS(:,3),'-h','LineWidth',4,'MarkerSize',10)
ylim([1.0/TotalTrails 0.55])
xlim([min(SNR) max(SNR)])
grid;
title('BER of Different Multiuser Detection Algorithms');
xlabel('SNR (dB)','FontSize',14,'FontWeight','bold');
ylabel('Bit-Error-Rate BER','FontSize',14,'FontWeight','bold');
legend('BPSK','MF with A_2/A_1=0.1','MF with A_2/A_1=1.0','MF with A_2/A_1=10','DD with A_2/A_1=1.0','MLS with A_2/A_1=0.1','MLS with A_2/A_1=1.0','MLS with A_2/A_1=10');
